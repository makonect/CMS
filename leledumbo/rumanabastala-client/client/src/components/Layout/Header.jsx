      ...
      <div className="container mx-auto px-4">
        ...
        <nav className="border-t border-blue-700">
          <div className="flex flex-col md:flex-row justify-between items-center py-3">
            ...
            <div className="flex flex-wrap gap-2 mb-3 md:mb-0">
              {categories.map(category => (
                <Link
                  ...
                  className="px-3 py-1 bg-blue-800 hover:bg-blue-700 rounded-full text-sm transition-colors"
                >
                  {category}
                </Link>
              ))}
            ...
            {/* Admin Link */}
            <a
              href="http://dashboard.leledumbo.com"
              className="px-4 py-2 bg-white text-blue-900 rounded-lg font-semibold hover:bg-gray-100 transition-colors text-sm"
            >
              Admin Dashboard
            </a>
          </div>
