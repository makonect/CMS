...
const Search = () => {
  ...
  useEffect(() => {
    const searchArticles = async () => {
      ...
      setLoading(true);
      try {
        const response = await axios.get(`/api/articles?website=rumanabastala&search=${encodeURIComponent(query)}&status=published`);
  ...
  return (
    <div className="space-y-6">
      <div className="text-center">
        <h1 className="text-4xl font-bold text-green-900 mb-2">Search Results</h1>
