    ...
    const fetchArticles = async () => {
      try {
        ...
        const [featuredResponse, latestResponse] = await Promise.all([
          axios.get('/api/articles?featured=true&status=published&limit=3'),
          axios.get('/api/articles?status=published&limit=10&sort=-createdAt')
        ]);
    ...
    <div className="space-y-8">
      ...
      <section>
        <div className="flex justify-between items-center mb-6">
          <h2 className="text-3xl font-bold text-blue-900 border-b-2 border-blue-200 pb-2">
            Latest News
          </h2>
          <Link 
            to="/search" 
